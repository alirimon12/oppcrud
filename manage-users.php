...

{
   ...
   $result=$obj->getData('user', '*', $arr_conditon);  
...

{
   ...
   $arr_conditon=array("name"=>$name, "email"=>$email, "mobile"=>$mobile );
...

   {
      ...
      $result=$obj->insertData('user', $arr_conditon);  

   }else{

      $result=$obj->updateData('user', $arr_conditon, 'id', $id );
